...
export const ContactInformation = (props) => {
  ...
  const [address, setAddress] = useState({ owner: "", country: "", stateProvince: "", zipPostcode: "", citySoum: "", apartmentSuite: "", detail: "", phoneNum: "" });
  ...
  console.log(userDetail.user.address);
    ...
    >
      <div className={ci.paymentSection__contactInformation__container}>
        ...
        <div className={clx(ci.emailSection)}>
          {!switchSections ? (
            <>
              <input type="email" placeholder="Your email *" onChange={(e) => setEmail(e.target.value)} value={email} className={ci.emailSection__emailInput} />
          ...
          {!switchSections ? (
            <>
              ...
              <div className={ci.importantInformation__ship__checkBox}>
                <input type="checkbox" />
                <p>
                  I have read and accept the&nbsp; <p className={ci.blackColorFont}>term & conditions</p>
                </p>
              </div>
            </>
          ) : (
            <div className={clx(ci.importantInformation__payBtnSection)}>
              <button className={ci.importantInformation__payBtnSection__payBtn} onClick={openBtn}>
                Pay now
              </button>
              ...
              <div className={clx(ci.importantInformation__payBtnSection__error, !error && ci.removeBtn)}>Choose your payment organization</div>
            </div>
          )}
        </div>
      </div>
