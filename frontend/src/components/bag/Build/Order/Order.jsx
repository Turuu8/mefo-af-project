      ...
      <div className={css.orderSection__container}>
        ...
        <div className={css.orderSection__container__documentsSection}>
          <div className={css.content}>
            ...
            <div className={css.sizeAndQuantity__dropdown}>
              ...
              <DropDown change={setSize} open={sizeOpen} setOpen={setSizeOpen} />
            </div>
            <div className={css.sizeAndQuantity__dropdown}>
              <input type="number" className={css.dropdown_btn} value={quantity} onChange={(e) => quantityFuction(e.target.value)} />
            </div>
            <p>USD 650.00</p>
        ...
        <div className={css.orderSection__container__phoneDocumentSection}>
          ...
          <div className={css.sizeAndQuantity}>
            ...
            <div className={css.sizeAndQuantity__dropdown}>
              <input type="number" min={1} className={css.dropdown_btn} value={quantity} onChange={(e) => quantityFuction(e.target.value)} />
            </div>
          </div>
        </div>
      </div>
